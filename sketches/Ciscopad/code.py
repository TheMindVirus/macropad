...
# Press any key to enter the REPL, type "import ciscopad" and press Enter
# To learn more, type "dir(ciscopad)" and press Enter to explore and develop further...
