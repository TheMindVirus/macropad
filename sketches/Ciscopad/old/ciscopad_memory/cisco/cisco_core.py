...
import ciscopad.lib.logging

from ciscopad import switch_core
from ciscopad.cisco.command_processor.config import ConfigCommandProcessor
from ciscopad.cisco.command_processor.config_interface import ConfigInterfaceCommandProcessor
from ciscopad.cisco.command_processor.config_vlan import ConfigVlanCommandProcessor
from ciscopad.cisco.command_processor.config_vrf import ConfigVRFCommandProcessor
from ciscopad.cisco.command_processor.default import DefaultCommandProcessor
from ciscopad.cisco.command_processor.enabled import EnabledCommandProcessor #Reached Here, MemoryError
from ciscopad.cisco.command_processor.piping import PipingProcessor
from ciscopad.command_processing.shell_session import ShellSession
from ciscopad.switch_configuration import Port
from ciscopad.terminal import LoggingTerminalController
...
class BaseCiscoSwitchCore(switch_core.SwitchCore):
    ...
    def launch(self, protocol, terminal_controller):
        ...
        self.logger = logging.getLogger(
            "ciscopad.cisco.%s.%s.%s" % (self.switch_configuration.name, self.last_connection_id, protocol))
