...
### A game of endurance coding to see who can build and operate the most complex multiplexer combo

![screenshot](https://github.com/TheMindVirus/macropad/blob/archive/sketches/MultiplexerMadness/screenshot.png)
